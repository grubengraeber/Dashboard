...
import { endpoints } from "../../../../Fetch/api/widgets/endpoints";
  ...
  return (
    <>
        <Grid container spacing={2} margin={"20px"}>
                <Grid item xs={2}>
                <Badge color="success" badgeContent={badgeContentShoppingList} showZero={false} >
                ...
                <Grid item xs={2}>
                    ...
                    <Badge color="success" badgeContent={badgeContentBudgetTracker} showZero>
                    <Card sx={{maxWidth: 200, maxHeight: 200}}
                          variant={"outlined"}>
